...
```{r}
network_cleaned = network_cleaned%>%
  mutate(Source = case_when(
    ...
    Source == "Kern County Water Agency" ~ "CA1510040",
    Source == "San Benito County Water District" ~ "CA3510007",
    T ~ Source),
    Source = ifelse(str_detect(Source, "^CA[0-9]"), Source, str_to_title(Source)),
    #System_name = str_to_title(System_name),
