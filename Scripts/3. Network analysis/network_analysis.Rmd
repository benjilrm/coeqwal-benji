...
Linear regression as robustness check
```{r}
...
```{r}
# Alternatively, create a more elegant solution that works for any number of variables
...
# Calculate percentiles for each cluster mean
