...
st_write(st_as_sf(enhanced_systems, coords = c("lon", "lat"), crs = crs), "Data/Interactive map/20250903_fake_systems.shp", delete_dsn = T)

st_write(st_as_sf(enhanced_sources, coords = c("source_lon", "source_lat"), crs = crs), "Data/Interactive map/20250903_fake_sources.shp")

st_write(create_connection_lines(enhanced_connections, enhanced_sources, enhanced_systems), "Data/Interactive map/20250903_fake_links.shp")
```
