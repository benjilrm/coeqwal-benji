...
systems_sf = network_w_lat_longs%>%
  select(system_name, pwsid, system_lat, system_lon, provider_type, county, pop_served, num_sw_sources, gw_access, gw_access_filter, system_size, any_swp_system, any_cvp_system, any_purchased_system)%>%
  unique()%>%
