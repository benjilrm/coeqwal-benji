...
```{r}
network = read.csv("Data/Outputs/20260511_network_joined.csv")
```
...
# Export
```{r}
st_write(connections_sf, "Data/Outputs/Shapefiles for dashboard/20260515_connections.shp", delete_dsn = T)

st_write(systems_sf, "Data/Outputs/Shapefiles for dashboard/20260515_systems.shp", delete_dsn = T)

st_write(jittered_sources, "Data/Outputs/Shapefiles for dashboard/20260515_sources.shp", delete_dsn = T)
```
