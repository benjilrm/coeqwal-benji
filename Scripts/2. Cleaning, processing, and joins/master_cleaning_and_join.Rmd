...
## Network data
```{r}
network_raw = read_excel("Data/Source/Network data/Final network data with updated DU for Benji May 11.xlsx", na = "NA")
```
...
# Export
```{r}
write.csv(network_w_looped_projects, "Data/Outputs/20260511_network_joined.csv", row.names = F)
```
