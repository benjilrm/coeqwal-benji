...
## Network data
```{r}
network_raw = read_excel("Data/Source/Network data/Updated network data for demand units April 13th V2.xlsx", na = "NA")
```
...
# Export
```{r}
write.csv(network_w_looped_projects, "Data/Outputs/20260423_network_joined.csv", row.names = F)
```
