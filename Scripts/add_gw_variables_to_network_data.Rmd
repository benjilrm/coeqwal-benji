...
clearinghouse_filtered%>%
  filter(clearinghouse_water_type == "Spring Water")
```
...
Additional note from EDT webpage – "care should be taken in interpreting the data. A single detection of a contaminant may not indicate contamination of a drinking water supply. If this detection is not confirmed with a follow-up detection, it may represent a false positive. 
