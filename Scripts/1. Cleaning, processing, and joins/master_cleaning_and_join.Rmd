...
## Network data
```{r}
network_raw = read.csv("Data/Source/Network data/Networkdata_updatedMarch272026.csv", na = "NA")
```
...
# Export
```{r}
write.csv(network_w_looped_projects, "Data/Outputs/20260330_network_joined.csv", row.names = F)
```
