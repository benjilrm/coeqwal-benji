...
network_raw%>%
  filter(pwsid == "CA1510022" | source_name == "CA1510022")%>%
  select(system_name, pwsid, source_name, source_type, system_lat:system_lon, source_lat:source_lon)
```
...
# Export
```{r}
write.csv(network_w_looped_projects, "Data/Outputs/20251210_network_joined.csv", row.names = F)
```
